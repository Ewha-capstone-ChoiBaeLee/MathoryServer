...
namespace SharedData.Models
{
    public class QuizEquation
    {
        ...
        public static (string result, string subject) PlusReturn(List<double> numbers)
        {
        ...
        public static (string result, string subject) MinusReturn(List<double> numbers)
        {
        ...
        public static (string result, string subject) MulReturn(List<double> numbers)
        {
            numbers.Sort((a, b) => b.CompareTo(a)); // 내림차순 정렬
            string result = string.Join(" * ", numbers);
            string subject = "The mathematics topic is arithmetic equation";
        ...
        //The mathematics topic is number comparison
        public static (string result, string subject) MinReturn(List<double> numbers)
        {
        ...
        // The mathematics topic is number comparison
        public static (string result, string subject) MaxReturn(List<double> numbers)
        {
            string subject = "The mathematics topic is number comparison";
            string result = "max(" + string.Join(", ", numbers) + ")";
            return (result, subject);
        }
        //The mathematics topic is divisors and multiples
        public static (string result, string subject) LcmReturn(List<double> numbers)
        {
        ...
        //The mathematics topic is average
        public static (string result, string subject) MeanReturn(List<double> numbers)
        {
            string subject = "The mathematics topic is average";
            string result = "statistics.mean(" + string.Join(", ", numbers) + ")";
            return (result, subject);
        }
        static (string result, string subject) first_grade()
        {
        ...
        static (string result, string subject) forth_grade()
        {
            List<double> numbers = new List<double>(); // List<double> 생성
